...
public class JavaInterface
{
    ...
    public static final Primitive[] primitives = {
             ...
             * new
             */
            new Primitive("new", INTERACTION_ENV, Primitive.IDENTIFIER, /* environment, type */
                          1, Primitive.VAR_ARGS, /* min, max no. of arguments */
                          "Makes a new Java object, e.g. (new 'java.util.Date)", null /* doc strings */)
            {
                @Override
                public Entity applyN(gleam.lang.List args, Environment env, Continuation cont) throws GleamException
                {
             ...
             * call
             */
            new Primitive("call", INTERACTION_ENV, Primitive.IDENTIFIER, /* environment, type */
                          2, Primitive.VAR_ARGS, /* min, max no. of arguments */
                          "Calls a method on a Java object", "E.g. (call 'length (new 'java.lang.String \"test\")) => 4" /* doc strings */)
            {
                @Override
                public Entity applyN(gleam.lang.List args, Environment env, Continuation cont) throws GleamException
                {
             ...
             * class-of
             */
            new Primitive("class-of", INTERACTION_ENV, Primitive.IDENTIFIER, /* environment, type */
                          1, 1, /* min, max no. of arguments */
                          "Returns the class of its argument", "E.g. (class-of (new 'java.lang.String \"test\")) => class java.lang.String" /* doc strings */)
            {
                @Override
